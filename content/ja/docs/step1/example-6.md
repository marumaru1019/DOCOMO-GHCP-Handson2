...
### 2.3 🧩 カスタムチャットモード（Custom Chat Modes）- 20以上
...
1. [awesome-copilot](https://github.com/github/awesome-copilot?tab=readme-ov-file)のカスタムチャットモードの一覧より「Plan Mode - Strategic Planning & Architecture Assistant」を見つけ、「VS Code Install」をクリック

2. VS Code を開くか確認が求められるので、開くを押して VS Code を開く

3. 「Plan Mode」がインポートされたら、チャットモードを「Plan」に切り替え
...
**Beast Mode**は、awesome-copilotの中でも特に人気の高いカスタムチャットモードで、GPT-4.1を最高レベルのコーディングエージェントとして活用できます。
...
1. [awesome-copilot](https://github.com/github/awesome-copilot?tab=readme-ov-file)のカスタムチャットモードの一覧より「4.1 Beast Mode」を見つけ、「VS Code Install」をクリック

2. VS Code を開くか確認が求められるので、開くを押して VS Code を開く

3. 「4.1 Beast Mode」がインポートされたら、チャットモードを「4.1 Beast Mode」に切り替え
